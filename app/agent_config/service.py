...
from app.agent_config.models import AgentRecord, ToolRecord
...
class AgentDefinitionService:
    ...
    async def create_agent(
        ...
        *,
        ...
        if tool_names:
            bound_tools = await self._validate_tool_names(tool_names)
    ...
    async def update_agent(
        ...
        *,
        ...
        if tool_names is not None:
            bound = await self._validate_tool_names(tool_names)
    ...
    async def _validate_tool_names(self, names: list[str]) -> list[str]:
        valid: list[str] = []
        for name in names:
