...
| --- | --- | --- | --- |
| CI（mock embedder, `--max-distance 1.0`） | vector-only | 100% | 100% |
| CI（mock embedder, `--max-distance 1.0`） | hybrid | 100% | 100% |
